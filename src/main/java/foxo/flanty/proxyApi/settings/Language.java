...
public class Language {
    public static final String apiUnavailable = "API is not available";//not config
    public static final String apiResponseError = "API return: ";//no config
    public static String registrationTitle1 = "Регистрация";//no config
    public static String registrationTitle2 = "Регистрация.";//no config
    ...
    public static String loginWelcome = "<#E14585>Добро пожаловать на <gold>Lactern";
    public static String loginMessage = "<dark_aqua>Авторизуйтесь с <white>/login <пароль>";
